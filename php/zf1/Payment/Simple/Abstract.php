<?php
abstract class Xan_Payment_Simple_Abstract extends Xan_Payment_Abstract
{
    /**
     ...
     * @return
     */
    public function addHtmlField($field, $value)
    {
     ...
     * @return void
     */
    public function submitHtmlPayment()
    {

        $this->prepareHtmlSubmit();
     ...
     * @return none
     */
    protected function prepareHtmlSubmit()
    {
        // Fill if needed
    }
